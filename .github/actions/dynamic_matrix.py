...
python_supported_versions = [
    ...
    if v["eol"] > now and v["cycle"] not in ["3.7", "3.8", "3.12"]
]
...
if __name__ == "__main__":
    ...
    print("::set-output name=os_matrix::{}".format(str(matrix[event]["os"])))
    print(
        "::set-output name=python_version_matrix::{}".format(str(matrix[event]["python_version"]))
    )
